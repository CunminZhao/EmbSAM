...
#from LLFlow.options import options as option
#from LLFlow.Measure import Measure, psnr
#from LLFlow.imresize import imresize
#from LLFlow.models import create_model
#from LLFlow.utils.util import opt_get
...
def enhance(cfgpath='./confs/LOL_smallNet.yml', out_dir='./wkdir/enhancement'):
