...
def findname(cellname):
    if "AB" in cellname:
        return './最终分割结果/cell_name/name_AB.csv'
    elif 'C' in cellname:
        return './最终分割结果/cell_name/name_C.csv'
    elif 'D' in cellname:
        return './最终分割结果/cell_name/name_D.csv'
    elif 'E' in cellname:
        return './最终分割结果/cell_name/name_E.csv'
    elif 'MS' in cellname:
        return './最终分割结果/cell_name/name_MS.csv'
    elif 'P4' in cellname:
        return './最终分割结果/cell_name/name_P4.csv'
    else:
        return None
